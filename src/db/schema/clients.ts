...
export const clients = pgTable('clients', {
  ...
  // Legacy free-text address — kept for back-compat with rows created before
  // the structured-address split. New clients use the 5 fields below.
  address: text('address'),
  addressLine: varchar('address_line', { length: 255 }),
  addressTown: varchar('address_town', { length: 100 }),
